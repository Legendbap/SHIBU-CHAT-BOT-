...
START = """**
🤖 ᴛʜɪs ɪs ᴀ sᴜᴘᴇʀғᴀsᴛ ᴄʜᴀᴛʙᴏᴛ ʙʏ sᴀɪᴍ 🚀
...
╔═════════════════╗
║ ➻ ᴍʏ ѕαιм ➪ [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://github.com/Legendbap/SHIBU-CHAT-BOT-) 🎁                
╚═════════════════╝
...
HELP_READ = f"""**
Cʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ʙᴇʟᴏᴡ ғᴏʀ ᴍᴏʀᴇ ɪɴғᴏʀᴍᴀᴛɪᴏɴ.  Iғ ʏᴏᴜ'ʀᴇ ғᴀᴄɪɴɢ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ ʏᴏᴜ ᴄᴀɴ ᴀsᴋ ɪɴ [ѕαιм ᴄʜᴀᴛ](https://t.me/xyz_own_world).
